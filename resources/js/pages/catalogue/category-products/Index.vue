<template>
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="p-4 flex h-full flex-1 flex-col gap-6 overflow-x-auto rounded-xl">
            ...
            <div class="table-wrapper">
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr v-for="categoria in categoriasProductos.data" :key="categoria.id">
                            <td class="td--strong">
                                {{ categoria.id }}
                            </td>
                            <td class="td--strong">
                        ...
                        <tr v-if="categoriasProductos.data.length === 0">
            ...
            <Pagination
                :links="categoriasProductos.links"
                :from="categoriasProductos.from"
                :to="categoriasProductos.to"
                :total="categoriasProductos.total"
            />
        </div>
...
const props = defineProps<{
    categoriasProductos: Paginated<CatalogueInterface>;
}>();
...
const submit = () => {
    if (isEditing.value && editingId.value) {
        form.put(`/product-category/${editingId.value}`, {
            preserveScroll: true,
